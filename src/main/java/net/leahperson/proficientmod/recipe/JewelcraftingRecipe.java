...
public class JewelcraftingRecipe implements Recipe<Container> {
    ...
    public JewelcraftingRecipe(ResourceLocation id, NonNullList<Ingredient> inputItems, ItemStack output,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipeSerializers.JEWELCRAFTING.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ModRecipeTypes.JEWELCRAFTING.get();
    }
}
