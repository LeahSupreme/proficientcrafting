...
public class JewelcraftingRecipeSerializer implements RecipeSerializer<JewelcraftingRecipe> {
    @Override
    public JewelcraftingRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
        ...
        return new JewelcraftingRecipe(recipeId, inputItems, output, outputs, proficiencyRequired,
                qualityRequired, qualityPerIngredient, levelCost, yieldCost, yieldAdded, craftTime,
                qualityDecoration);
    }

    @Override
    public @Nullable JewelcraftingRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buf) {
        ...
        return new JewelcraftingRecipe(recipeId, inputItems, output, outputs, proficiencyRequired,
                qualityRequired, qualityPerIngredient, levelCost, yieldCost, yieldAdded, craftTime, qualityDecoration);
    }

    @Override
    public void toNetwork(FriendlyByteBuf buf, JewelcraftingRecipe recipe) {
