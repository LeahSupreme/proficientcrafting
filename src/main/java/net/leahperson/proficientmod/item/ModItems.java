...
public class ModItems {
    ...
    public static final RegistryObject<Item> DIAMOND_FORGE_HAMMER = ITEMS.register("diamond_forge_hammer",
            () -> new ForgeHammerItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_forge_hammer.proficiency", 20.0)),
    ...
    public static final RegistryObject<Item> GOLD_FORGE_HAMMER = ITEMS.register("gold_forge_hammer",
            () -> new ForgeHammerItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_forge_hammer.yield", 10.0)),
                    new Item.Properties()));
    ...
    public static final RegistryObject<Item> AMETHYST_FORGE_HAMMER = ITEMS.register("amethyst_forge_hammer",
            () -> new ForgeHammerItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_forge_hammer.quality", 10.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> NETHERITE_FORGE_HAMMER = ITEMS.register("netherite_forge_hammer",
            () -> new ForgeHammerItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_forge_hammer.proficiency", 30.0),
                            new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_forge_hammer.quality", 10.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_LADLE = ITEMS.register("diamond_ladle",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_ladle.proficiency", 20.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> GOLD_LADLE = ITEMS.register("gold_ladle",
            () -> new CraftingToolItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_ladle.yield", 10.0)),
                    new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> AMETHYST_LADLE = ITEMS.register("amethyst_ladle",
            () -> new CraftingToolItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_ladle.quality", 10.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> NETHERITE_LADLE = ITEMS.register("netherite_ladle",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_ladle.proficiency", 30.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_CHISEL = ITEMS.register("diamond_chisel",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_chisel.proficiency", 20.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> GOLD_CHISEL = ITEMS.register("gold_chisel",
            () -> new CraftingToolItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_chisel.yield", 10.0)),
                    new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> NETHERITE_CHISEL = ITEMS.register("netherite_chisel",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_chisel.proficiency", 30.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> GOLD_SAW = ITEMS.register("gold_saw",
            () -> new SawItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_saw.yield", 10.0)),
                    new Item.Properties()));

    public static final RegistryObject<Item> DIAMOND_SAW = ITEMS.register("diamond_saw",
            () -> new SawItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_saw.proficiency", 20.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> AMETHYST_SAW = ITEMS.register("amethyst_saw",
            () -> new SawItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_saw.quality", 10.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> NETHERITE_SAW = ITEMS.register("netherite_saw",
            () -> new SawItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_saw.proficiency", 30.0)),
                    new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> DIAMOND_TIPPED_QUILL = ITEMS.register("diamond_tipped_quill",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_tipped_quill.proficiency", 20.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> NETHERITE_TIPPED_QUILL = ITEMS.register("netherite_tipped_quill",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_tipped_quill.proficiency", 30.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));

    public static final RegistryObject<Item> AMETHYST_SCEPTER = ITEMS.register("amethyst_scepter",
            () -> new CraftingToolItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_scepter.quality", 10.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_SCEPTER = ITEMS.register("diamond_scepter",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:diamond_scepter.quality", 20.0)),
    ...
    public static final RegistryObject<Item> EMERALD_SCEPTER = ITEMS.register("emerald_scepter",
            () -> new CraftingToolItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:emerald_scepter.quality", 30.0)),
    ...
    public static final RegistryObject<Item> NETHER_STAR_SCEPTER = ITEMS.register("nether_star_scepter",
            () -> new CraftingToolItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:nether_star_scepter.quality", 50.0)),
