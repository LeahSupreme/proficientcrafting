...
public class ModItems {
    ...
    public static final RegistryObject<Item> STONE_FORGE_HAMMER = ITEMS.register("stone_forge_hammer",
            () -> new ForgeHammerItem(Tiers.STONE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:stone_forge_hammer.proficiency", 5.0)),
    ...
    public static final RegistryObject<Item> IRON_FORGE_HAMMER = ITEMS.register("iron_forge_hammer",
            () -> new ForgeHammerItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:iron_forge_hammer.proficiency", 10.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_FORGE_HAMMER = ITEMS.register("diamond_forge_hammer",
            () -> new ForgeHammerItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_forge_hammer.proficiency", 15.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON).durability(1024)));

    public static final RegistryObject<Item> GOLD_FORGE_HAMMER = ITEMS.register("gold_forge_hammer",
            () -> new ForgeHammerItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_forge_hammer.yield", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:gold_forge_hammer.proficiency", 5.0)),
    ...
    public static final RegistryObject<Item> AMETHYST_FORGE_HAMMER = ITEMS.register("amethyst_forge_hammer",
            () -> new ForgeHammerItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_forge_hammer.quality", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:amethyst_forge_hammer.proficiency", 5.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON).durability(64)));
    ...
    public static final RegistryObject<Item> NETHERITE_FORGE_HAMMER = ITEMS.register("netherite_forge_hammer",
            () -> new ForgeHammerItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_forge_hammer.proficiency", 20.0),
                            new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_forge_hammer.quality", 8.0)),
                    new Item.Properties().rarity(Rarity.RARE).durability(2000)));

    public static final RegistryObject<Item> WOODEN_LADLE = ITEMS.register("wooden_ladle",
            () -> new CraftingToolItem(Tiers.WOOD,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:wooden_ladle.proficiency", 5.0)),
                    new Item.Properties().durability(64)));

    public static final RegistryObject<Item> IRON_LADLE = ITEMS.register("iron_ladle",
            () -> new CraftingToolItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:iron_ladle.proficiency", 10.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_LADLE = ITEMS.register("diamond_ladle",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_ladle.proficiency", 15.0)),
    ...
    public static final RegistryObject<Item> GOLD_LADLE = ITEMS.register("gold_ladle",
            () -> new CraftingToolItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_ladle.yield", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:gold_ladle.proficiency", 5.0)),
    ...
    public static final RegistryObject<Item> AMETHYST_LADLE = ITEMS.register("amethyst_ladle",
            () -> new CraftingToolItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_ladle.quality", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:amethyst_ladle.proficiency", 5.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).durability(64)));
    ...
    public static final RegistryObject<Item> NETHERITE_LADLE = ITEMS.register("netherite_ladle",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_ladle.proficiency", 20.0),new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_ladle.quality", 8.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).durability(2000)));

    public static final RegistryObject<Item> IRON_CHISEL = ITEMS.register("iron_chisel",
            () -> new CraftingToolItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:iron_chisel.proficiency", 10.0)),
                    new Item.Properties().stacksTo(1).durability(128)));
    ...
    public static final RegistryObject<Item> NETHERITE_CHISEL = ITEMS.register("netherite_chisel",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_chisel.proficiency", 20.0),new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_chisel.quality", 8.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).durability(2000)));

    public static final RegistryObject<Item> IRON_SAW = ITEMS.register("iron_saw",
            () -> new SawItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:iron_saw.proficiency", 10.0)),
                    new Item.Properties().durability(128)));

    public static final RegistryObject<Item> GOLD_SAW = ITEMS.register("gold_saw",
            () -> new SawItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.YIELD.get(), "qualitycrafting:gold_saw.yield", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:gold_saw.proficiency", 5.0)),
                    new Item.Properties().durability(32)));

    public static final RegistryObject<Item> DIAMOND_SAW = ITEMS.register("diamond_saw",
            () -> new SawItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_saw.proficiency", 15.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON).durability(1024)));

    public static final RegistryObject<Item> AMETHYST_SAW = ITEMS.register("amethyst_saw",
            () -> new SawItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:amethyst_saw.quality", 5.0),new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:amethyst_saw.proficiency", 5.0)),
                    new Item.Properties().rarity(Rarity.UNCOMMON).durability(64)));

    public static final RegistryObject<Item> NETHERITE_SAW = ITEMS.register("netherite_saw",
            () -> new SawItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_saw.proficiency", 20.0),new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_saw.quality", 8.0)),
                    new Item.Properties().rarity(Rarity.RARE).durability(2000)));

    public static final RegistryObject<Item> IRON_TIPPED_QUILL = ITEMS.register("iron_tipped_quill",
            () -> new CraftingToolItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:iron_tipped_quill.proficiency", 10.0)),
                    new Item.Properties().stacksTo(1).durability(128)));

    public static final RegistryObject<Item> DIAMOND_TIPPED_QUILL = ITEMS.register("diamond_tipped_quill",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_tipped_quill.proficiency", 15.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).durability(1024)));

    public static final RegistryObject<Item> NETHERITE_TIPPED_QUILL = ITEMS.register("netherite_tipped_quill",
            () -> new CraftingToolItem(Tiers.NETHERITE,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:netherite_tipped_quill.proficiency", 20.0),new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:netherite_tipped_quill.quality", 8.0)),
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).durability(2000)));

    public static final RegistryObject<Item> AMETHYST_SCEPTER = ITEMS.register("amethyst_scepter",
            () -> new CraftingToolItem(ModTiers.AMETHYST,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:amethyst_scepter.proficiency", 10.0)),
    ...
    public static final RegistryObject<Item> DIAMOND_SCEPTER = ITEMS.register("diamond_scepter",
            () -> new CraftingToolItem(Tiers.DIAMOND,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:diamond_scepter.proficiency", 20.0)),
                    new Item.Properties().stacksTo(1).durability(1500).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> EMERALD_SCEPTER = ITEMS.register("emerald_scepter",
            () -> new CraftingToolItem(Tiers.IRON,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:emerald_scepter.proficiency", 15.0)),
                    new Item.Properties().stacksTo(1).durability(300).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> NETHER_STAR_SCEPTER = ITEMS.register("nether_star_scepter",
            () -> new CraftingToolItem(Tiers.GOLD,
                    List.of(new AttributeBonus(ModAttributes.PROFICIENCY.get(), "qualitycrafting:nether_star_scepter.proficiency", 30.0),new AttributeBonus(ModAttributes.QUALITY.get(), "qualitycrafting:nether_star_scepter.proficiency", 10.0)),
