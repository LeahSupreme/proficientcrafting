...
public class WorkbenchCategory implements IRecipeCategory<WorkbenchRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(ProficientMod.MOD_ID, "workbench");
    public static final RecipeType<WorkbenchRecipe> WORKBENCH_TYPE = new RecipeType<>(UID, WorkbenchRecipe.class);
    ...
    public Component getTitle() {
        return Component.translatable("block.qualitycrafting.workbench");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, WorkbenchRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.CATALYST, 90, 52)
                .addItemStack(new ItemStack(ModBlocks.WORKBENCH.get()));
        builder.addSlot(RecipeIngredientRole.CATALYST, 90, 12)
                .addIngredients(Ingredient.of(ModTags.Items.WOODWORKING_SAW));
