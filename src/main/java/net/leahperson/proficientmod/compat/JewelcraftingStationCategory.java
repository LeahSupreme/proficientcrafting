...
public class JewelcraftingStationCategory implements IRecipeCategory<JewelcraftingRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(ProficientMod.MOD_ID, "jewelcrafting_station");
    public static final RecipeType<JewelcraftingRecipe> JEWELCRAFTING_STATION_TYPE = new RecipeType<>(UID, JewelcraftingRecipe.class);
    ...
    public JewelcraftingStationCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(
                ...
                0, 0, 246, 165);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.JEWELCRAFTING_STATION.get()));
    }

    @Override
    public RecipeType<JewelcraftingRecipe> getRecipeType() {
        return JEWELCRAFTING_STATION_TYPE;
    }
    ...
    public Component getTitle() {
        return Component.translatable("block.qualitycrafting.jewelcrafting_station");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, JewelcraftingRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.CATALYST, 90, 12)
                .addIngredients(Ingredient.of(ModTags.Items.JEWEL_CHISEL));
    ...
    @Override
    public void draw(JewelcraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
